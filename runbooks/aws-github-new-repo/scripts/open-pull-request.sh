...
TITLE="Add Gruntwork Pipelines bootstrap for {{ .inputs.AccountName }} [skip ci]"
BODY="Scaffolds the infrastructure-live repository with the Pipelines GitHub Actions workflows and the {{ .inputs.AccountName }} account bootstrap (OIDC provider + plan/apply IAM roles). Generated with a Gruntwork Runbook."
