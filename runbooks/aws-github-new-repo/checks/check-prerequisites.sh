...
missing=0
for tool in git mise boilerplate aws gh jq; do
...
if [ "$missing" -ne 0 ]; then
  ...
  log_error "git: https://git-scm.com/downloads | mise: https://mise.jdx.dev | aws: https://docs.aws.amazon.com/cli/ | gh: https://cli.github.com"
  exit 1
fi
