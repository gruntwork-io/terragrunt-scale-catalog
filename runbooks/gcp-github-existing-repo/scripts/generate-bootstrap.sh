#!/bin/bash
# Render the gcp/github/project boilerplate template into the cloned repository, using values
# collected from the form and auto-derived from GitHub + GCP. Runs non-interactively.
set -euo pipefail
...
log_info "Generated {{ .inputs.ProjectName }}/bootstrap/, {{ .inputs.ProjectName }}/project.hcl, and .gruntwork/environment-{{ .inputs.ProjectName }}.hcl"
