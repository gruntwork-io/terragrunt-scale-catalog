...
missing=0
for tool in git mise boilerplate gcloud gh jq; do
...
if [ "$missing" -ne 0 ]; then
  ...
  log_error "git: https://git-scm.com/downloads | mise: https://mise.jdx.dev | gcloud: https://cloud.google.com/sdk/docs/install | gh: https://cli.github.com"
  exit 1
fi
