...
BODY="Adds the Pipelines GitHub Actions workflow and the {{ .inputs.AccountName }} account bootstrap (OIDC provider + plan/apply IAM roles). Generated with a Gruntwork Runbook."
