...
missing=0
for tool in git mise boilerplate gcloud glab jq; do
...
if [ "$missing" -ne 0 ]; then
  ...
  log_error "git: https://git-scm.com/downloads | mise: https://mise.jdx.dev | gcloud: https://cloud.google.com/sdk/docs/install | glab: https://gitlab.com/gitlab-org/cli"
  exit 1
fi
