...
missing=0
for tool in git mise az glab jq; do
...
if [ "$missing" -ne 0 ]; then
  ...
  log_error "git: https://git-scm.com/downloads | mise: https://mise.jdx.dev | az: https://learn.microsoft.com/cli/azure/install-azure-cli | glab: https://gitlab.com/gitlab-org/cli | jq: https://jqlang.github.io/jq/"
  exit 1
fi
