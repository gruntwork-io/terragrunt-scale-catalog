...
missing=0
for tool in git mise boilerplate aws glab jq; do
...
if [ "$missing" -ne 0 ]; then
  ...
  log_error "git: https://git-scm.com/downloads | mise: https://mise.jdx.dev | aws: https://docs.aws.amazon.com/cli/ | glab: https://gitlab.com/gitlab-org/cli"
  exit 1
fi
