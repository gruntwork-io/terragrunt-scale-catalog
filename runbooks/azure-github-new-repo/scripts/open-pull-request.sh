...
BODY="Scaffolds the infrastructure-live repository with the Pipelines GitHub Actions workflows and the {{ .inputs.SubscriptionName }} subscription bootstrap (Entra ID plan/apply applications + Azure Blob state backend). Generated with a Gruntwork Runbook."
