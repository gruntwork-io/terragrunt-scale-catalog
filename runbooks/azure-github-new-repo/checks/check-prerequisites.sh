...
missing=0
for tool in git mise boilerplate az gh jq; do
...
if [ "$missing" -ne 0 ]; then
  ...
  log_error "git: https://git-scm.com/downloads | mise: https://mise.jdx.dev | az: https://learn.microsoft.com/cli/azure/install-azure-cli | gh: https://cli.github.com | jq: https://jqlang.github.io/jq/"
  exit 1
fi
