...
BODY="Adds the Gruntwork Pipelines scaffold (root.hcl, GitHub Actions workflows, and the {{ .inputs.ProjectName }} project bootstrap: Workload Identity Pool + plan/apply service accounts). Generated with a Gruntwork Runbook."
