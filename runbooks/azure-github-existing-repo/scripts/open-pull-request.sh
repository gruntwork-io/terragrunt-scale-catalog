...
BODY="Adds the Pipelines GitHub Actions workflow and the {{ .inputs.SubscriptionName }} subscription bootstrap (Entra ID plan/apply applications + Azure Blob state backend). Generated with a Gruntwork Runbook."
