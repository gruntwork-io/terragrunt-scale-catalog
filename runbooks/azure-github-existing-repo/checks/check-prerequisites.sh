...
if [ "$missing" -ne 0 ]; then
  ...
  log_error "git: https://git-scm.com/downloads | mise: https://mise.jdx.dev | az: https://learn.microsoft.com/cli/azure/install-azure-cli"
  exit 1
fi
